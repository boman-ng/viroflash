// Rust adaptation of minimap2 2.30's sdust.c (MIT).
// Upstream copyright: Dana-Farber Cancer Institute (2018-), Broad Institute
// (2017-2018). Original Rust modifications: Copyright (c) 2026 boman-ng,
// BSD-3-Clause. Retain both notices; see THIRD_PARTY_NOTICES.md.
